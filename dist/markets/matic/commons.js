...
exports.CommonsConfig = {
    ...
    OracleQuoteUnit: constants_1.oneEther.toString(),
    ...
    LendingRateOracleRatesCommon: {
        ...
        DAI: {
            borrowRate: constants_1.oneRay.multipliedBy(0.039).toFixed(),
        },
        TUSD: {
            borrowRate: constants_1.oneRay.multipliedBy(0.035).toFixed(),
        },
        USDC: {
            borrowRate: constants_1.oneRay.multipliedBy(0.039).toFixed(),
        },
    ...
    PoolAdmin: {
        ...
        [types_1.eEthereumNetwork.main]: undefined,
    ...
    ProviderRegistry: {
        [types_1.eEthereumNetwork.kovan]: '0x1E40B561EC587036f9789aF83236f057D1ed2A90',
        [types_1.eEthereumNetwork.ropsten]: '',
        [types_1.eEthereumNetwork.main]: '0x52D306e36E3B6B02c153d0266ff0f85d18BCD413',
        [types_1.eEthereumNetwork.coverage]: '',
        [types_1.eEthereumNetwork.hardhat]: '',
        [types_1.eEthereumNetwork.buidlerevm]: '',
        [types_1.eEthereumNetwork.tenderly]: '0x52D306e36E3B6B02c153d0266ff0f85d18BCD413',
    },
    ProviderRegistryOwner: {
        [types_1.eEthereumNetwork.kovan]: '0x85e4A467343c0dc4aDAB74Af84448D9c45D8ae6F',
        [types_1.eEthereumNetwork.ropsten]: '',
        [types_1.eEthereumNetwork.main]: '0xB9062896ec3A615a4e4444DF183F0531a77218AE',
        [types_1.eEthereumNetwork.coverage]: '',
        [types_1.eEthereumNetwork.hardhat]: '',
        [types_1.eEthereumNetwork.buidlerevm]: '',
        [types_1.eEthereumNetwork.tenderly]: '0xB9062896ec3A615a4e4444DF183F0531a77218AE',
    },
    LendingRateOracle: {
        [types_1.eEthereumNetwork.coverage]: '',
        [types_1.eEthereumNetwork.hardhat]: '',
        ...
        [types_1.eEthereumNetwork.ropsten]: '0x05dcca805a6562c1bdd0423768754acb6993241b',
        [types_1.eEthereumNetwork.main]: '',
        [types_1.eEthereumNetwork.tenderly]: '0x8A32f49FFbA88aba6EFF96F45D8BD1D4b3f35c7D',
    },
    LendingPoolCollateralManager: {
        [types_1.eEthereumNetwork.coverage]: '',
        [types_1.eEthereumNetwork.hardhat]: '',
        [types_1.eEthereumNetwork.buidlerevm]: '',
        [types_1.eEthereumNetwork.kovan]: '0x9269b6453d0d75370c4c85e5a42977a53efdb72a',
        [types_1.eEthereumNetwork.ropsten]: '',
        [types_1.eEthereumNetwork.main]: '0xbd4765210d4167CE2A5b87280D9E8Ee316D5EC7C',
        [types_1.eEthereumNetwork.tenderly]: '0xbd4765210d4167CE2A5b87280D9E8Ee316D5EC7C',
    },
    ...
    TokenDistributor: {
        ...
        [types_1.eEthereumNetwork.buidlerevm]: '',
        [types_1.eEthereumNetwork.hardhat]: '',
        [types_1.eEthereumNetwork.kovan]: '0x971efe90088f21dc6a36f610ffed77fc19710708',
        [types_1.eEthereumNetwork.ropsten]: '0xeba2ea67942b8250d870b12750b594696d02fc9c',
        [types_1.eEthereumNetwork.main]: '0xe3d9988f676457123c5fd01297605efdd0cba1ae',
        [types_1.eEthereumNetwork.tenderly]: '0xe3d9988f676457123c5fd01297605efdd0cba1ae',
    },
    AaveOracle: {
        [types_1.eEthereumNetwork.coverage]: '',
        [types_1.eEthereumNetwork.hardhat]: '',
        [types_1.eEthereumNetwork.buidlerevm]: '',
        [types_1.eEthereumNetwork.kovan]: '',
        [types_1.eEthereumNetwork.ropsten]: constants_1.ZERO_ADDRESS,
        [types_1.eEthereumNetwork.main]: '',
        [types_1.eEthereumNetwork.tenderly]: '0xA50ba011c48153De246E5192C8f9258A2ba79Ca9',
    },
    FallbackOracle: {
        [types_1.eEthereumNetwork.coverage]: '',
        [types_1.eEthereumNetwork.hardhat]: '',
        ...
        [types_1.eEthereumNetwork.ropsten]: '0xAD1a978cdbb8175b2eaeC47B01404f8AEC5f4F0d',
        [types_1.eEthereumNetwork.main]: constants_1.ZERO_ADDRESS,
        [types_1.eEthereumNetwork.tenderly]: constants_1.ZERO_ADDRESS,
    },
    ChainlinkAggregator: {
        [types_1.eEthereumNetwork.coverage]: {},
        [types_1.eEthereumNetwork.hardhat]: {},
        ...
        [types_1.eEthereumNetwork.main]: {
            ...
            Tricrypto2: constants_1.ZERO_ADDRESS,
            ThreePool: constants_1.ZERO_ADDRESS,
            StethEth: constants_1.ZERO_ADDRESS,
            Steth: '0x86392dC19c0b719886221c78AB11eb8Cf5c52812',
            FraxUSDC: constants_1.ZERO_ADDRESS,
            Frax3Crv: constants_1.ZERO_ADDRESS,
    ...
    ATokenDomainSeparator: {
        [types_1.eEthereumNetwork.coverage]: '0x95b73a72c6ecf4ccbbba5178800023260bad8e75cdccdb8e4827a2977a37c820',
        [types_1.eEthereumNetwork.hardhat]: '0xbae024d959c6a022dc5ed37294cd39c141034b2ae5f02a955cce75c930a81bf5',
        [types_1.eEthereumNetwork.buidlerevm]: '0xbae024d959c6a022dc5ed37294cd39c141034b2ae5f02a955cce75c930a81bf5',
        [types_1.eEthereumNetwork.kovan]: '',
        [types_1.eEthereumNetwork.ropsten]: '',
        [types_1.eEthereumNetwork.main]: '',
        [types_1.eEthereumNetwork.tenderly]: '',
    ...
    WETH: {
        ...
        [types_1.eEthereumNetwork.hardhat]: '',
        [types_1.eEthereumNetwork.buidlerevm]: '',
        [types_1.eEthereumNetwork.kovan]: '0xd0a1e359811322d97991e03f863a0c30c2cf029c',
        [types_1.eEthereumNetwork.ropsten]: '0xc778417e063141139fce010982780140aa0cd5ab',
        [types_1.eEthereumNetwork.main]: '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
        [types_1.eEthereumNetwork.tenderly]: '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
    },
    WrappedNativeToken: {
        [types_1.eEthereumNetwork.coverage]: '',
        [types_1.eEthereumNetwork.hardhat]: '',
    ...
    ReserveFactorTreasuryAddress: {
        [types_1.eEthereumNetwork.coverage]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
        [types_1.eEthereumNetwork.hardhat]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
        [types_1.eEthereumNetwork.buidlerevm]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
        [types_1.eEthereumNetwork.kovan]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
        [types_1.eEthereumNetwork.ropsten]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
        [types_1.eEthereumNetwork.main]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
        [types_1.eEthereumNetwork.tenderly]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
    },
    IncentivesController: {
        [types_1.eEthereumNetwork.coverage]: constants_1.ZERO_ADDRESS,
        [types_1.eEthereumNetwork.hardhat]: constants_1.ZERO_ADDRESS,
        [types_1.eEthereumNetwork.buidlerevm]: constants_1.ZERO_ADDRESS,
        [types_1.eEthereumNetwork.kovan]: constants_1.ZERO_ADDRESS,
        [types_1.eEthereumNetwork.ropsten]: constants_1.ZERO_ADDRESS,
        [types_1.eEthereumNetwork.main]: constants_1.ZERO_ADDRESS,
        [types_1.eEthereumNetwork.tenderly]: constants_1.ZERO_ADDRESS,
    },
