...
class DefenderRelaySenderProvider {
    ...
    send(payload, callback) {
        ...
        const handleWith = (fn) => util_1.callbackify((payload) => {
            var _a;
            return fn.call(this, (_a = payload.params) !== null && _a !== void 0 ? _a : []).then((result) => ({
                jsonrpc: '2.0',
                id,
                result,
            }));
    ...
    async _sendTransaction(params) {
        ...
        const txWithSpeed = this.options.speed
            ? { ...lodash_1.omit(tx, 'gasPrice', 'maxFeePerGas', 'maxPriorityFeePerGas'), speed: this.options.speed }
            : tx;
