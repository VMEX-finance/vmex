...
exports.OptimismConfig = {
    ...
    ReservesConfig: {
        ...
        wstETH: reservesConfigs_1.strategywstETH,
        FRAX: reservesConfigs_1.strategyFRAX,
        OP: reservesConfigs_1.strategyOP,
        rETH: reservesConfigs_1.strategyRETH,
        ThreeCRV: reservesConfigs_1.strategy3Curve,
        sUSD3CRV: reservesConfigs_1.strategysUSD3Curve,
        wstETHCRV: reservesConfigs_1.strategywstETHCRV,
        // mooCurveFsUSD: strategyBeefyToken,
        mooCurveWSTETH: reservesConfigs_1.strategyBeefywstETHCRVToken,
        velo_rETHWETH: reservesConfigs_1.strategyVelorETH,
        velo_wstETHWETH: reservesConfigs_1.strategyVelowstETHWETH,
        // moo_velo_wstETHWETH: strategyBeefyToken,
        velo_USDCsUSD: reservesConfigs_1.strategyVeloUSDCsUSD,
        // moo_velo_USDCsUSD: strategyBeefyToken,
        velo_ETHUSDC: reservesConfigs_1.strategyVeloETHUSDC,
        // moo_velo_ETHUSDC: strategyBeefyToken,
        velo_OPETH: reservesConfigs_1.strategyVeloOPETH,
        // moo_velo_OPETH: strategyBeefyToken,
        // velo_ETHSNX: strategyVeloToken,
        // moo_velo_ETHSNX: strategyBeefyToken,
        velo_OPUSDC: reservesConfigs_1.strategyVeloOPUSDC,
        // moo_velo_OPUSDC: strategyBeefyToken,
        velo_DAIUSDC: reservesConfigs_1.strategyVeloDAIUSDC,
        // moo_velo_DAIUSDC: strategyBeefyToken,
        // velo_FRAXUSDC: strategyVeloStableToken,
        // moo_velo_FRAXUSDC: strategyBeefyToken,
        velo_USDTUSDC: reservesConfigs_1.strategyVeloUSDTUSDC,
        // moo_velo_USDTUSDC: strategyBeefyToken,
        // beethoven_USDCDAI: strategyBeethovenToken,
        beethoven_wstETHETH: reservesConfigs_1.strategyBeethovenwstETHETH,
        // beethoven_WETHOPUSDC: strategyBeethovenToken,
        beethoven_rETHETH: reservesConfigs_1.strategyBeethovenrETHETH,
        yvUSDC: reservesConfigs_1.strategyStableYearn,
        yvUSDT: reservesConfigs_1.strategyStableYearn,
        yvDAI: reservesConfigs_1.strategyStableYearn,
        yvWETH: reservesConfigs_1.strategyYearnWETHToken,
        LUSD: reservesConfigs_1.strategyLUSD,
        velo_LUSDWETH: reservesConfigs_1.strategyVeloLUSDWETH,
        velo_LUSDUSDC: reservesConfigs_1.strategyVeloLUSDUSDC,
    },
    ReserveAssets: {
...
exports.default = exports.OptimismConfig;
