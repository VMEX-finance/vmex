...
interface IUiIncentiveDataProviderV2Interface extends ethers.utils.Interface {
  functions: {
...
export class IUiIncentiveDataProviderV2 extends Contract {
  ...
  interface: IUiIncentiveDataProviderV2Interface;
