...
interface BaseUniswapAdapterInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseUniswapAdapter extends Contract {
  ...
  interface: BaseUniswapAdapterInterface;
