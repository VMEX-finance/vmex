...
exports.ILendingPoolConfiguratorFactory = void 0;
const ethers_1 = require("ethers");
class ILendingPoolConfiguratorFactory {
    static connect(address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    }
}
exports.ILendingPoolConfiguratorFactory = ILendingPoolConfiguratorFactory;
const _abi = [
    {
        anonymous: false,
        inputs: [
...
//# sourceMappingURL=ILendingPoolConfiguratorFactory.js.map