...
(0, config_1.task)("full:initialize-lending-pool-tranches-0-OP", "Initialize lending pool tranche 1 configuration.")
    ...
    try {
        ...
        let [assets0, reserveFactors0, canBorrow0, canBeCollateral0] = (0, init_helpers_1.getTranche0MockedDataOP)(reserveAssets);
        ...
        await (0, init_helpers_1.claimTrancheId)("Vmex tranche 1", admin);
        // Pause market during deployment
        await (0, misc_utils_1.waitForTx)(await lendingPoolConfiguratorProxy.connect(admin).setTranchePause(true, 1));
        let [assets1, reserveFactors1, canBorrow1, canBeCollateral1] = (0, init_helpers_1.getTranche1MockedDataOP)(reserveAssets);
        await (0, init_helpers_1.initReservesByHelper)(assets1, reserveFactors1, canBorrow1, canBeCollateral1, admin, treasuryAddress, 1);
        // Unpause market during deployment
        await (0, misc_utils_1.waitForTx)(await lendingPoolConfiguratorProxy
            .connect(admin)
...
//# sourceMappingURL=6.1-initializeTranchesOP.js.map