...
interface CvxStrategyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "cvxRewardsPool()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "cvxRewardsPool",
    values?: undefined
  ): string;
...
export class CvxStrategy extends Contract {
  ...
  interface: CvxStrategyInterface;
  ...
  functions: {
    ...
    cvxRewardsPool(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  cvxRewardsPool(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    cvxRewardsPool(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    cvxRewardsPool(overrides?: CallOverrides): Promise<PopulatedTransaction>;
