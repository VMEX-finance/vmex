...
//     //     await pool.deposit(weth.address, tranche, parseEther('10000'), deployer.address, 0);
...
//     //     await pool.connect(user).deposit(usdc.address, tranche, flashloanTotal, userAddress, 0);
...
//     //     await pool.deposit(dai.address, tranche, collateralAmount, borrowerAddress, 0);
//     //     await pool.connect(borrower).borrow(weth.address, tranche, parseEther('5000'), 2, 0, borrowerAddress);
//     //   });
