  ...
  if (
    ...
    await setInitialAssetPricesInOracle(
      ALL_ASSETS_INITIAL_PRICES,
      {
        ...
        "BPT-WSTETH-WETH": ZERO_ADDRESS,
        beethoven_WETHOPUSDC: ZERO_ADDRESS,
        rETH: ZERO_ADDRESS,
        "BPT-rETH-ETH": ZERO_ADDRESS,
        yvUSDC: ZERO_ADDRESS,
        yvUSDT: ZERO_ADDRESS,
        yvDAI: ZERO_ADDRESS,
        yvWETH: ZERO_ADDRESS,
