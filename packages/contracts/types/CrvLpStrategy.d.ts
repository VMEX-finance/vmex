...
interface CrvLpStrategyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(address,address,uint64,uint256,uint8,address,address)": FunctionFragment;
...
export class CrvLpStrategy extends Contract {
  ...
  interface: CrvLpStrategyInterface;
  ...
  functions: {
    ...
    "initialize(address,address,uint64,uint256,uint8,address,address)"(
      _addressProvider: string,
      _underlying: string,
      _tranche: BigNumberish,
      _pid: BigNumberish,
