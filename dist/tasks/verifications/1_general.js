...
(0, config_1.task)('verify:general', 'Verify contracts at Etherscan')
    ...
    if (all) {
        ...
        const walletProvider = await (0, contracts_getters_1.getWalletProvider)();
        ...
        await (0, contracts_helpers_1.verifyContract)(types_1.eContractid.AaveProtocolDataProvider, dataProvider, [
            addressesProvider.address,
        ]);
        // Wallet balance provider
        console.log('\n- Verifying  Wallet Balance Provider...\n');
        await (0, contracts_helpers_1.verifyContract)(types_1.eContractid.WalletBalanceProvider, walletProvider, []);
        // WETHGateway
