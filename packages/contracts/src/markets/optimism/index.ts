...
import { IOptimismConfiguration, eEthereumNetwork, eOptimismNetwork } from '../../types';
...
export const OptimismConfig: IOptimismConfiguration = {
  ...
  ReservesConfig: {
    ...
    OP: strategyOP,
    rETH: strategyRETH,
    ThreeCRV: strategy3Curve,
    sUSD3CRV: strategysUSD3Curve,
    ...
    velo_wstETHWETH: strategyVelowstETHWETH,
    // moo_velo_wstETHWETH: strategyBeefyToken,
    velo_USDCsUSD: strategyVeloUSDCsUSD,
    // moo_velo_USDCsUSD: strategyBeefyToken,
    velo_ETHUSDC: strategyVeloETHUSDC,
    ...
    velo_DAIUSDC: strategyVeloDAIUSDC,
    ...
    beethoven_wstETHETH: strategyBeethovenwstETHETH,
    // beethoven_WETHOPUSDC: strategyBeethovenToken,
    beethoven_rETHETH: strategyBeethovenrETHETH,
    yvUSDC: strategyStableYearn,
    yvUSDT: strategyStableYearn,
    yvDAI: strategyStableYearn,
    yvWETH: strategyYearnWETHToken,
    LUSD: strategyLUSD,
    velo_LUSDWETH: strategyVeloLUSDWETH,
    velo_LUSDUSDC: strategyVeloLUSDUSDC,
  },
  ReserveAssets: {
