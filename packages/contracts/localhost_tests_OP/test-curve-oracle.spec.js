...
(0, make_suite_1.makeSuite)("curve oracle test ", () => {
    ...
    it("test pricing", async () => {
        ...
        for (let i = 0; i < curveAssets.length; i++) {
            ...
            const beefyVault = new misc_utils_1.DRE.ethers.Contract(beefyAddr[i], beefyAbi);
            ...
            var cumProduct = 1;
            var minAmount = ethers_1.ethers.constants.MaxUint256;
            // if(i==1){
            ...
            expect(diff).to.be.lte(0.01, "Curve prices do not match");
        }
    });
});
//# sourceMappingURL=test-curve-oracle.spec.js.map