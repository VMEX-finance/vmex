...
import { IAaveConfiguration, eEthereumNetwork } from '../../types';
...
export const AaveConfig: IAaveConfiguration = {
  ...
  ReservesConfig: {
    ...
    yvTricrypto2: strategyYearnToken, //Curve TODO: add other curve lp tokens, modify custom strategies
    yvThreePool: strategyYearnToken,
    yvStethEth: strategyYearnToken,
    yvFraxUSDC: strategyYearnToken,
    yvFrax3Crv: strategyYearnToken,
  },
  ReserveAssets: {
    ...
    [eEthereumNetwork.goerli]: {
      ...
      ALCX: '0xB20C808861524a4A769e5fa93173A93B1b4aCfFD', //test ALCX (more holders and transfers)
      Oneinch: '',
    },
