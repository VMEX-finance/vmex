...
const getRewardsBalanceScenarios: ScenarioAction[] = [
  {
    caseName: 'Correctly claim 0 reward',
    emissionPerSecond: '0',
    amountToClaim: '0',
  },
  {
    caseName: 'Incorrectly claim nonzero reward',
    emissionPerSecond: '0',
    amountToClaim: '100',
  },
  {
    caseName: 'Correctly claim nonzero reward',
...
makeSuite('ExternalRewardDistributor claimReward, batchClaimReward tests', (testEnv) => {
  for (const {
    caseName,
