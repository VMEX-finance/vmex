...
export const MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  ...
  "3CRV": oneEther.multipliedBy("0.00369068412860").toFixed(),
  "sUSD3CRV-f": oneEther.multipliedBy("0.00369068412860").toFixed(),
  ...
  "vAMMV2-wstETH/WETH": oneEther.toFixed(),
  moo_velo_wstETHWETH: oneEther.toFixed(),
  "sAMMV2-USDC/sUSD": oneEther.toFixed(),
  moo_velo_USDCsUSD: oneEther.toFixed(),
  "vAMMV2-WETH/USDC": oneEther.toFixed(),
  ...
  "sAMMV2-USDC/DAI": oneEther.toFixed(),
