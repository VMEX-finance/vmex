...
async function main () {
  ...
  const curveOracle = new ethers.Contract(curveOracleAdd,curveOracleAbi);

    const pricePerToken = curveOracle.connect(signer).getAssetPrice("0xc4AD29ba4B3c580e6D59105FFf484999997675Ff");
