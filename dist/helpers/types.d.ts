...
export declare type eNetwork = eEthereumNetwork | ePolygonNetwork | eXDaiNetwork | eAvalancheNetwork;
...
export declare type tStringTokenBigUnits = string;
export declare type tBigNumberTokenBigUnits = BigNumber;
export declare type tStringTokenSmallUnits = string;
export declare type tBigNumberTokenSmallUnits = BigNumber;
...
export declare type iAavePoolAssets<T> = Pick<iAssetsWithoutUSD<T>, "DAI" | "TUSD" | "USDC" | "USDT" | "SUSD" | "AAVE" | "BAT" | "MKR" | "LINK" | "KNC" | "WBTC" | "MANA" | "ZRX" | "SNX" | "BUSD" | "WETH" | "YFI" | "UNI" | "REN" | "ENJ" | "xSUSHI">;
...
export declare type iAvalanchePoolAssets<T> = Pick<iAssetsWithoutUSD<T>, "WETH" | "DAI" | "USDT" | "AAVE" | "WBTC" | "WAVAX" | "USDC">;
export declare type iMultiPoolsAssets<T> = iAssetCommon<T> | iAavePoolAssets<T>;
export declare type iAavePoolTokens<T> = Omit<iAavePoolAssets<T>, "ETH">;
export declare type iAssetAggregatorBase<T> = iAssetsWithoutETH<T>;
...
export declare type iParamsPerNetwork<T> = iEthereumParamsPerNetwork<T> | iPolygonParamsPerNetwork<T> | iXDaiParamsPerNetwork<T> | iAvalancheParamsPerNetwork<T>;
...
export declare type PoolConfiguration = ICommonConfiguration | IAaveConfiguration;
