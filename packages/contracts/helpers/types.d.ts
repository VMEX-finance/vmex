...
export type eNetwork = eEthereumNetwork | ePolygonNetwork | eXDaiNetwork | eAvalancheNetwork | eOptimismNetwork;
...
export declare enum ProtocolErrors {
    CALLER_NOT_TRANCHE_ADMIN = "33",
    CALLER_NOT_GLOBAL_ADMIN = "0",
    ...
    LPC_NOT_WHITELISTED_TRANCHE_CREATION = "84",
    LPC_NOT_APPROVED_BORROWABLE = "86",
    LPC_NOT_APPROVED_COLLATERAL = "87",
    ...
    VO_REENTRANCY_GUARD_FAIL = "94",
    VO_UNDERLYING_FAIL = "95",
    VO_ORACLE_ADDRESS_NOT_FOUND = "96",
    VO_SEQUENCER_DOWN = "97",
    VO_SEQUENCER_GRACE_PERIOD_NOT_OVER = "98",
    VO_BASE_CURRENCY_SET_ONLY_ONCE = "99",
    AM_ASSET_ALREADY_IN_MAPPINGS = "100",
    AM_ASSET_NOT_CONTRACT = "101",
    AM_INTEREST_STRATEGY_NOT_CONTRACT = "102",
...
export type iAavePoolAssets<T> = Partial<Pick<iAssetsWithoutUSD<T>, "DAI" | "TUSD" | "USDC" | "USDT" | "SUSD" | "AAVE" | "BAT" | "MKR" | "LINK" | "KNC" | "WBTC" | "MANA" | "ZRX" | "SNX" | "BUSD" | "WETH" | "YFI" | "UNI" | "REN" | "ENJ" | "Tricrypto2" | "ThreePool" | "StethEth" | "Steth" | "FraxUSDC" | "Frax3Crv" | "FRAX" | "BAL" | "CRV" | "CVX" | "BADGER" | "LDO" | "ALCX" | "Oneinch" | "yvTricrypto2" | "yvThreePool" | "yvStethEth" | "yvFraxUSDC" | "yvFrax3Crv">>;
...
export type iAvalanchePoolAssets<T> = Pick<iAssetsWithoutUSD<T>, "WETH" | "DAI" | "USDT" | "AAVE" | "WBTC" | "WAVAX" | "USDC">;
export type iOptimismPoolAssets<T> = Partial<Pick<iAssetsWithoutUSD<T>, "DAI" | "USDC" | "USDT" | "SUSD" | "WBTC" | "SNX" | "WETH" | "wstETH" | "FRAX" | "OP" | "rETH" | "ThreeCRV" | "sUSD3CRV" | "wstETHCRV" | "mooCurveFsUSD" | "mooCurveWSTETH" | "velo_rETHWETH" | "velo_wstETHWETH" | "moo_velo_wstETHWETH" | "velo_USDCsUSD" | "moo_velo_USDCsUSD" | "velo_ETHUSDC" | "moo_velo_ETHUSDC" | "velo_OPETH" | "moo_velo_OPETH" | "velo_ETHSNX" | "moo_velo_ETHSNX" | "velo_OPUSDC" | "moo_velo_OPUSDC" | "velo_DAIUSDC" | "moo_velo_DAIUSDC" | "velo_FRAXUSDC" | "moo_velo_FRAXUSDC" | "velo_USDTUSDC" | "moo_velo_USDTUSDC" | "beethoven_USDCDAI" | "beethoven_wstETHETH" | "beethoven_WETHOPUSDC" | "beethoven_rETHETH" | "yvUSDC" | "yvUSDT" | "yvDAI" | "yvWETH" | "LUSD" | "velo_LUSDWETH" | "velo_LUSDUSDC">>;
...
export type iParamsPerNetwork<T> = iEthereumParamsPerNetwork<T> | iPolygonParamsPerNetwork<T> | iXDaiParamsPerNetwork<T> | iAvalancheParamsPerNetwork<T> | iOptimismParamsPerNetwork<T>;
