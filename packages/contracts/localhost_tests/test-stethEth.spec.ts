...
var triCryptoDepositAbi = fs.readFileSync("./localhost_tests/abis/stethEth.json").toString()
          ...
          it("get LP tokens", async () => {
            ...
            var amounts = [ethers.utils.parseEther("100"),ethers.utils.parseEther("0")]

            await myWETH.connect(signer).approve(triCryptoDeposit.address,DRE.ethers.utils.parseEther("100000000.0"))

            var options3 = {value: ethers.utils.parseEther("100")}
