...
export declare const newCompilerConfig: (config: HardhatConfig, sourcePath?: string | undefined) => TenderlyContractConfig;
export declare const extractCompilerVersion: (config: HardhatConfig, sourcePath?: string | undefined) => string;
