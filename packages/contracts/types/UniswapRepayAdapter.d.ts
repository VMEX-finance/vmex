...
interface UniswapRepayAdapterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "swapAndRepay(tuple,tuple,uint256,uint256,uint256,tuple,bool)": FunctionFragment;
...
export class UniswapRepayAdapter extends Contract {
  ...
  interface: UniswapRepayAdapterInterface;
