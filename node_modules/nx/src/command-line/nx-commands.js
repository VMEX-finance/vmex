...
exports.commandsObject = yargs
    ...
    builder: (yargs) => linkToNxDevAndExamples(withAffectedOptions(withTargetOption(withPrintAffectedOptions(yargs), false)), 'print-affected'),
    handler: (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
function withTargetOption(yargs, demandOption = true) {
