...
import {DistributionManager} from "./DistributionManagerVeVMEX.sol";
    ...
    ExternalRewardDistributor
{
    ...
    **/
    ...
    function _transferPenaltyRewards(address reward, uint256 penaltyAmount) internal override {
        IERC20(reward).safeTransferFrom(REWARDS_VAULT, PENALTY_RECIEVER, penaltyAmount);
    }
