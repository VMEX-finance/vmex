...
contract DistributionManager is IDistributionManager, Initializable {
  ...
  function setVeVmex(address veVmexAddress) external {
    require(msg.sender == EMISSION_MANAGER, 'ONLY_EMISSION_MANAGER');
    VE_VMEX = veVmexAddress;
  }
  ...
  function getAssetReward(address asset, address rewardAddress) external view returns (uint128, uint128, uint256, uint128) {
